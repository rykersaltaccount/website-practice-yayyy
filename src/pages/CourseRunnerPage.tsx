...
const CourseRunnerPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    setIsLoading(true);
    void generateCourseLesson(course, sourceLesson.title).then(generated => {
      if (generated) {
